...
import com.aiken.vendingmachine.ui.components.CategoryFilterBar
import com.aiken.vendingmachine.ui.components.ProductCard
import com.aiken.vendingmachine.ui.components.TopCarouselSection
...
fun HomeScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            // Top Carousel Section (40% of screen)
            Box(
                modifier = Modifier
                    .fillMaxWidth()
